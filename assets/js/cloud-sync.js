...
const CAMPOS = {
  ...
  // Progreso del quiz por dificultad (Fácil / Normal / Difícil / Experto)
  quiz_facil_jugados:       'quiz_facil_jugados',
  quiz_facil_aprobados:     'quiz_facil_aprobados',
  quiz_facil_mejor:         'quiz_facil_mejor',
  quiz_normal_jugados:      'quiz_normal_jugados',
  quiz_normal_aprobados:    'quiz_normal_aprobados',
  quiz_normal_mejor:        'quiz_normal_mejor',
  quiz_dificil_jugados:     'quiz_dificil_jugados',
  quiz_dificil_aprobados:   'quiz_dificil_aprobados',
  quiz_dificil_mejor:       'quiz_dificil_mejor',
  quiz_experto_jugados:     'quiz_experto_jugados',
  quiz_experto_aprobados:   'quiz_experto_aprobados',
  quiz_experto_mejor:       'quiz_experto_mejor',
};
...
function docPorDefecto() {
  return {
    ...
    quiz_facil_jugados: 0, quiz_facil_aprobados: 0, quiz_facil_mejor: 0,
    quiz_normal_jugados: 0, quiz_normal_aprobados: 0, quiz_normal_mejor: 0,
    quiz_dificil_jugados: 0, quiz_dificil_aprobados: 0, quiz_dificil_mejor: 0,
    quiz_experto_jugados: 0, quiz_experto_aprobados: 0, quiz_experto_mejor: 0,
  };
}
